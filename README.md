...
30. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[Understanding the Optimization settings](https://support.ntop.com/hc/en-us/articles/360048490154-Understanding-the-Optimization-settings)** · 新增：2026-07-13 · Support，更新 2026-05-18；FAQ / 支持文章，当前未见直接 `Example File` / 下载链接。  
   适合：想把拓扑优化里的求解控制参数真正调明白的人，适合在正式跑 topopt 前补齐 optimization settings、迭代节奏和结果稳定性判断。

31. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[How to define a passive region for optimization](https://support.ntop.com/hc/en-us/articles/24854202367891-How-to-define-a-passive-region-for-optimization)** · 新增：2026-07-13 · Support，更新 2026-05-18；FAQ / 支持文章，当前未见直接 `Example File` / 下载链接。  
   适合：想在拓扑优化里明确哪些区域必须保留、哪些区域允许演化的人，适合处理接口、安装面、载荷路径和制造保留区这类“不能动”的设计边界。

32. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[Can I use more than one objective in a Topology Optimization?](https://support.ntop.com/hc/en-us/articles/360048490094-Can-I-use-more-than-one-objective-in-a-Topology-Optimization)** · 新增：2026-07-14 · Support，更新 2026-05-18；FAQ / 支持文章，当前未见直接 `Example File` / 下载链接。  
   适合：已经开始做多载荷或多性能权衡的人，适合补齐 multiple objectives、权重分配和“一个优化里怎样同时表达多个设计意图”的设置思路。

33. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[How do I use geometric constraints](https://support.ntop.com/hc/en-us/articles/360048167613-How-do-I-use-geometric-constraints)** · 新增：2026-07-15 · Support，更新 2026-05-18；FAQ / 支持文章，当前未见直接 `Example File` / 下载链接。
   适合：想把拓扑优化约束从“体积分数”推进到几何控制的人，适合补齐 symmetry、planar/surface 类几何约束以及结果形态约束的使用边界。

34. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[How to use the Overhang Constraint](https://support.ntop.com/hc/en-us/articles/360060738793-How-to-use-the-Overhang-Constraint)** · 新增：2026-07-15 · Support，更新 2026-05-18；FAQ / 支持文章，当前未见直接 `Example File` / 下载链接。
   适合：想把可打印性直接带进拓扑优化的人，适合补齐 overhang constraint、增材制造自支撑方向控制和制造约束下的 topopt 思路。
...
36. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[Running Topology Optimization](https://learn.ntop.com/courses/340-topology-optimization/lessons/running-topology-optimization/)** · 新增：2026-06-14 · nTop Learn；课程主线 lesson。
   适合：已经搭好 FE 模型和约束、想补齐求解阶段判断逻辑的人，适合系统理解拓扑优化运行节奏、迭代观察和结果收敛前后的检查点。

37. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[Post Processing](https://learn.ntop.com/courses/340-topology-optimization/lessons/post-processing/)** · 新增：2026-07-12 · nTop Learn；课程主线 lesson，位于求解之后，专门讲 raw topopt 结果如何进入重建、平滑和可制造几何整理阶段。
   适合：已经跑出优化结果、但还没把它真正变成 CAD/制造几何的人，适合先补清后处理主线，再去跟做 starter file 和 complete file。

38. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[Follow Along: Post Processing](https://learn.ntop.com/courses/340-topology-optimization/lessons/follow-along-post-processing/)** · 新增：2026-06-13 · nTop Learn；follow-along lesson，提供 `.ntop` starter file + 讲义 PDF，课程页标注 last updated in `nTop 5.12.2`。
...
39. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[Download: Post Processing](https://learn.ntop.com/courses/340-topology-optimization/lessons/download-post-processing/)** · 新增：2026-06-13 · nTop Learn；下载课件，提供 `.ntop` 完整文件，课程页标注 last updated in `nTop 5.12.2`。
...
40. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[Optional: TopOpt Problem Statement](https://learn.ntop.com/courses/340-topology-optimization/lessons/optional-topopt-problem-statement/)** · 新增：2026-07-10 · nTop Learn；可选测试题页面，提供 `.ntop` starter file，适合把前面目标、约束与求解流程串成一次独立练习。
   适合：想脱离讲解自己完整跑一遍 topopt 小题的人，适合用 starter file 检查 setup 是否真的内化，而不只是照着 follow-along 点按钮。

41. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[Answer to TopOpt Test Problem](https://learn.ntop.com/courses/340-topology-optimization/lessons/answer-to-topopt-test-problem/)** · 新增：2026-06-14 · nTop Learn；课程答案页。
...
43. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[Advanced Topology Optimization](https://learn.ntop.com/lessons/advanced-topology-optimization/)** · 新增：2026-07-11 · nTop Learn；recorded training，聚焦 multiple load cases + multiple constraints 的“从零搭起”拓扑优化流程，并提供 zip 下载包。
...
44. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[How to import topology optimization results from Altair OptiStruct into nTop](https://support.ntop.com/hc/en-us/articles/1500000156701-How-to-import-topology-optimization-results-from-Altair-Optistruct-into-nTop)** · 新增：2026-07-14 · Support，更新 2026-05-18；工作流 / 支持文章，当前未见直接 `Example File` / 下载链接。
   适合：已经在 OptiStruct 跑过拓扑优化、想把结果带回 nTop 做重建和后处理的人，适合补齐外部求解结果导入、清理与 implicit workflow 衔接这条链路。
...
34. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[How to create a Simulation Model](https://support.ntop.com/hc/en-us/articles/360038337054-How-to-create-a-Simulation-Model)** · 新增：2026-07-17 · Support，更新 2026-04-02；`Example File`。  
    文件：[`Simulation Model Example.ntop`](https://files.learn.ntop.com/Support%20Article%20Example%20Files/Knowledge%20Base/Simulation/Simulation%20Model%20Example.ntop)。  
    适合：想把 CAD / implicit geometry 真正整理成可求解 FE 模型的人，适合补齐 body 到 simulation model 的转换、材料赋值、网格准备和仿真前处理主线。  

35. ![新增](https://img.shields.io/badge/%E6%96%B0%E5%A2%9E-brightgreen) **[How to run a static analysis](https://support.ntop.com/hc/en-us/articles/360038372754-How-to-run-a-static-analysis)** · 新增：2026-07-17 · Support，更新 2026-04-02；`Example File`。  
    文件：[`Static Analysis Example.ntop`](https://files.learn.ntop.com/Support%20Article%20Example%20Files/Knowledge%20Base/Simulation/Static%20Analysis%20Example.ntop)。  
    适合：想用最短链路跑通线弹性静力仿真的人，适合把载荷、约束、位移/应力结果查看和后续 field-driven design 衔接一次串起来。  

36. **[How to use nTop Automate in ModeFrontier DOE workflows](https://support.ntop.com/hc/en-us/articles/360052078394-How-to-use-nTop-Automate-in-ModeFrontier-DOE-workflows)** · Support，2026-03-16；视频 + `Mode Frontier Example.zip`。  
    适合：ModeFrontier DOE/MDO，JSON 输入输出，nTop Automate 接外部设计探索平台。  

37. **[nTop Learn 课程总览：nTop Automate（Course 330）](https://learn.ntop.com/courses/330-ntop-automate/)** · nTop Learn 课程页，含多个 follow-along / completed files。  
    适合：系统学习 CLI、`ntopcl`、批处理、参数探索；再按章节下载对应 `.ntop` / zip。  

38. **[nTop Learn 课程总览：Intro to Field-Driven Design（Course 220）](https://learn.ntop.com/courses/220-intro-to-field-driven-design/)** · nTop Learn 课程页，含多个 follow-along / completed files。  
    适合：field 概念、常用 block、组合套路和完整 bracket 小项目复盘。  

39. **[How to loft between profiles](https://support.ntop.com/hc/en-us/articles/1500000929422-How-to-loft-between-profiles)** · Support，更新 2026-04-02；提供 `.ntop` `Example File`（`loft_profiles.ntop`）。  
    > ![已读](https://img.shields.io/badge/%E5%B7%B2%E8%AF%BB-red) 已读：2026-05-16  
    适合：在多个 2D profiles 间生成平滑过渡体，练习 loft、截面轮廓、implicit body 与参数化截面建模。  

40. **[How to create a surface mesh](https://support.ntop.com/hc/en-us/articles/360038828913-How-to-create-a-surface-mesh)** · Support，更新 2026-04-02；提供 `Example File`。  
    > ![已读](https://img.shields.io/badge/%E5%B7%B2%E8%AF%BB-red) 已读：2026-05-16  
    适合：把 implicit body / CAD body 转成高质量 surface mesh，练习网格尺寸、tolerance、feature preservation 与制造/仿真前处理。
